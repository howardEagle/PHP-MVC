...
<div id="top">
    <div class="fixed">
        ...
        <ul class="top-menu">
            ...
            <li class="dropdown">
                <a class="user-menu" data-toggle="dropdown"><img src="img/userpic.png" alt=""/><span>Howdy, Eugene! <b
    ...
    <div class="sidebar-tabs">
        ...
        <div id="general">
            ...
            <div class="sidebar-user widget">
                <div class="navbar">
                    <div class="navbar-inner"><h6>Wazzup, Eugene!</h6></div>
                </div>
            ...
            <ul class="navigation widget">
                ...
                <li><a href="#" title="" class="expand"><i class="icon-warning-sign"></i>Error
                ...
                <li><a href="#" title="" class="expand"><i class="icon-indent-right"></i>Menu
                        levels<strong>3</strong></a>
                    <ul>
        ...
        <div class="crumbs">
            ...
            <ul class="alt-buttons">
                ...
                <li class="dropdown"><a href="#" title="" data-toggle="dropdown"><i
                            class="icon-tasks"></i><span>Tasks</span> <strong>(+16)</strong></a>
