    ...
    <div class="actions">
        ...
        <div id="user-stats">
            <ul class="round-buttons">
                ...
                <li>
                    <div class="depth"><a href="" title="View statement" class="tip"><i class="icon-signal"></i></a>
                    </div>
                </li>
                <li>
                ...
                <li>
                    <div class="depth"><a href="" title="Create new task" class="tip"><i class="icon-tasks"></i></a>
                    </div>
                </li>
                <li>
                    <div class="depth"><a href="" title="Layout settings" class="tip"><i class="icon-cogs"></i></a>
                    </div>
                </li>
            </ul>
        </div>
...
<div class="row-fluid">
    ...
    <div class="span4">
        <div class="widget">
            <div class="navbar">
                <div class="navbar-inner"><h6>Earnings statistic</h6></div>
            </div>
            <div class="well body">
    ...
    <div class="span4">
        <div class="widget">
            <div class="navbar">
                <div class="navbar-inner"><h6>Visitor statistics</h6></div>
            </div>
            <div class="well body">
                <ul class="stats-details">
                    <li>
    ...
    <div class="span4">
        <div class="widget">
            <div class="navbar">
                <div class="navbar-inner"><h6>Click statistics</h6></div>
            </div>
            <div class="well body">
                <ul class="stats-details">
                    <li>
                    ...
                    <li>
                        <div class="number">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="#" title=""><i class="icon-refresh"></i>Reload data</a></li>
                                <li><a href="#" title=""><i class="icon-calendar"></i>Change time period</a></li>
                                <li><a href="#" title=""><i class="icon-cog"></i>Parameters<strong
                                            class="badge badge-info">9</strong></a></li>
                                <li><a href="#" title=""><i class="icon-download-alt"></i>Download statement</a></li>
                            </ul>
                            <span>168k+</span>
                        </div>
        ...
        <div class="widget">
            <div class="well">
                ...
                <div class="item-info">
                    ...
                    <p>Donec id elit non mi porta gravida at eget metus. Praesent commodo cursus magna, vel scelerisque
                        nisl consectetur mollis ornare vel leo.</p>
...
<div class="row-fluid">
    <div class="span6">
        ...
        <div class="widget">
            <div class="navbar">
                <div class="navbar-inner"><h6>Pre, code styles</h6></div>
            </div>
            <div class="well body">
